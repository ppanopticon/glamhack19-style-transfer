...
from services.PostcardAccess import PostcardAccess
...
api.add_resource(PostcardAccess, '/postcard/image/<postcard_id>') # Route_3: Access postcard image
api.add_resource(PostcardAudio, '/postcard/audio/<postcard_id>') # Route_4: Access postcard ambient audio
